    ...
    public static class Register {
        ...
        public static void RegisterItems(final RegistryEvent.Register<Item> event) {
            final Item[] items = {
                ...
                new Item((new Item.Properties()).group(SpudUp.GROUP).maxStackSize(64).food(Foods.GOLDEN_BAKED_POTATO).rarity(Rarity.RARE)).setRegistryName(SpudUp.location("golden_baked_potato")),
                new EnchantedGoldenAppleItem((new Item.Properties()).group(SpudUp.GROUP).maxStackSize(64).food(Foods.ENCHANTED_GOLDEN_BAKED_POTATO).rarity(Rarity.EPIC)).setRegistryName(SpudUp.location("enchanted_golden_baked_potato")),
                new Item((new Item.Properties()).group(SpudUp.GROUP).maxStackSize(64).food(Foods.THICC_BAKED_POTATO).rarity(Rarity.EPIC)).setRegistryName(SpudUp.location("thicc_baked_potato"))
            };
